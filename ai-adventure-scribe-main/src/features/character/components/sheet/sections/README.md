...
## Key Files
- `AbilityScores.tsx` - [Brief description]
- `BasicInfo.tsx` - [Brief description]
- `ClassFeatureTracker.tsx` - [Brief description]
- `CombatStats.tsx` - [Brief description]
- `Equipment.tsx` - [Brief description]
- `FightingStylesDisplay.tsx` - [Brief description]
