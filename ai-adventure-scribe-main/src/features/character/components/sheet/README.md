...
## Key Files
- `ExperienceManager.tsx` - [Brief description]
- `InspirationTracker.tsx` - [Brief description]
- `InventoryManager.tsx` - [Brief description]
- `MulticlassManager.tsx` - [Brief description]
- `PersonalityManager.tsx` - [Brief description]
- `character-sheet-tabs.tsx` - [Brief description]
- `character-sheet.tsx` - [Brief description]
