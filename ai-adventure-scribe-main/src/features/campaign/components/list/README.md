...
## Key Files
- `CampaignListSkeleton.tsx` - [Brief description]
- `campaign-card.tsx` - [Brief description]
- `campaign-list.tsx` - [Brief description]
- `campaign-skeleton.tsx` - [Brief description]
- `character-selection-modal.tsx` - [Brief description]
- `empty-state.tsx` - [Brief description]
