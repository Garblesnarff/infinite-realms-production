...
## Key Files
- `BasicDetails.tsx` - [Brief description]
- `CampaignEnhancements.tsx` - [Brief description]
- `CampaignParameters.tsx` - [Brief description]
- `GenreSelection.test.tsx` - [Brief description]
- `GenreSelection.tsx` - [Brief description]
