...
## Key Files
- `ConnectionStateManager.ts` - [Brief description]
- `ConnectionStateService.ts` - [Brief description]
- `EventEmitter.ts` - [Brief description]
- `ReconnectionManager.ts` - [Brief description]
