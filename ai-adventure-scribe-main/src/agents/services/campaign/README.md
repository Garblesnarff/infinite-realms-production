...
## Key Files
- `CachedCampaignContextProvider.ts` - [Brief description]
- `CampaignContextProvider.ts` - [Brief description]
- `campaign-context-loader.ts` - [Brief description]
- `character-loader.ts` - [Brief description]
