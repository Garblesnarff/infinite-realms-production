...
## Key Files
- `EnhancedMemoryManager.ts` - [Brief description]
- `MemoryImportanceService.ts` - [Brief description]
- `MemoryManager.ts` - [Brief description]
- `MemoryRepository.ts` - [Brief description]
- `MemoryService.ts` - [Brief description]
- `SceneStateTracker.ts` - [Brief description]
- `memory-loader.ts` - [Brief description]
