...
## Key Files
- `CharacterInteractionGenerator.ts` - [Brief description]
- `ResponseCoordinator.ts` - [Brief description]
- `ResponsePipeline.ts` - [Brief description]
- `character-interaction-generator.ts` - [Brief description]
- `environment-generator.ts` - [Brief description]
- `mechanics-generator.ts` - [Brief description]
- `opportunity-generator.ts` - [Brief description]
