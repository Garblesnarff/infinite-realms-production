...
## Key Files
- `AIExecutionManager.ts` - [Brief description]
- `AIExecutionStrategy.ts` - [Brief description]
- `EdgeFunctionStrategy.ts` - [Brief description]
- `LocalFallbackStrategy.ts` - [Brief description]
